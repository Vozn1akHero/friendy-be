...
namespace BE.Models
{
    public class FriendyContext : DbContext
    {
        ...
        public virtual DbSet<EventParticipationRequest> EventParticipationRequest
        {
            get;
            set;
        }
        ...
        public virtual DbSet<FriendshipRecommendation> FriendshipRecommendation
        {
            get;
            set;
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(
                    "Server=.\\SQLEXPRESS;Database=friendy;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Chat>(entity =>
            {
                ...
                entity.Property(e => e.FirstParticipantId)
                    .HasColumnName("first_participant_id");

                entity.Property(e => e.SecondParticipantId)
            ...
            modelBuilder.Entity<CommentResponseLike>(entity =>
            {
                ...
                entity.Property(e => e.CommentResponseId)
                    .HasColumnName("comment_response_id");
            ...
            modelBuilder.Entity<Event>(entity =>
            {
                ...
                entity.Property(e => e.ParticipantsAmount)
                    .HasColumnName("participants_amount");
            ...
            modelBuilder.Entity<FriendshipRecommendation>(entity =>
            {
                ...
                entity.Property(e => e.PotentialFriendId)
                    .HasColumnName("potential_friend_id");
            ...
            modelBuilder.Entity<ResponseToComment>(entity =>
            {
                ...
                entity.Property(e => e.ResponseToCommentId)
                    .HasColumnName("response_to_comment_id");
            ...
            modelBuilder.Entity<UserAdditionalInfo>(entity =>
            {
                ...
                entity.Property(e => e.AlcoholAttitudeId)
                    .HasColumnName("alcohol_attitude_id");
                ...
                entity.Property(e => e.SmokingAttitudeId)
                    .HasColumnName("smoking_attitude_id");
