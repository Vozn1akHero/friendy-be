...
namespace BE.Models
{
    public class User
    {
        public User()
        {
            ...
            FriendshipRecommendationPotentialFriend =
                new HashSet<FriendshipRecommendation>();
        ...
        public virtual ICollection<EventParticipationRequest> EventParticipationRequest
        {
            get;
            set;
        }
        ...
        public virtual ICollection<FriendshipRecommendation>
            FriendshipRecommendationIssuer { get; set; }

        public virtual ICollection<FriendshipRecommendation>
            FriendshipRecommendationPotentialFriend { get; set; }
        ...
        public virtual ICollection<UserFriendship> UserFriendshipSecondFriend
        {
            get;
            set;
        }
