...
namespace BE.Repositories.Interfaces
{
    public interface IEventPostRepository : IRepositoryBase<EventPost>
    {
        ...
        Task<IEnumerable<EventPost>> GetLastRangeByIdAsync(int eventId, int lastIndex, int length);
        Task<IEnumerable<EventPost>> GetLastRangeByIdWithPaginationAsync(int eventId, int page);
    }
}