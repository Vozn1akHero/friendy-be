...
namespace BE.Features.Event
{
    ...
    public class EventAdminsController : ControllerBase
    {
        ...
        [Authorize]
        [Route("is-admin/{id}")]
        public async Task<IActionResult> CheckIfAdmin(int id,
            [FromHeader(Name = "userId")] int userId)
        {
            var result = await _repository.EventAdmins.IsUserAdminById(id, userId);
            return Ok(result);
        }
        ...
        [Route("all/{id}")]
        public async Task<IActionResult> GetAdminList(int id,
            [FromHeader(Name = "userId")] int userId)
        {
        ...
        [AuthorizeEventCreator]
        [Route("{id}")]
        public async Task<IActionResult> DeleteByEventIdAndAdminId(int id,
            [FromQuery(Name = "adminId")] int adminId)
        {
