...
{
    public class FoundUserDtoProfile : Profile
    {
        public FoundUserDtoProfile()
        {
            CreateMap<User, UserDto>()
                ...
                .ForMember(dest => dest.EducationId,
                    opt => opt.MapFrom(src => src.EducationId))
                ...
                .ForMember(dest => dest.UserInterests, opt => opt.MapFrom(src => src
                    .UserInterests.Select(e => new UserInterestDto
                    {
                        Id = e.Id,
